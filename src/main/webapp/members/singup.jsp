...
#emailAuthCode {
    ...
    outline: none;
    font-size: 18px;
    width: 230px; /* ID/NickName input과 같은 폭 */
    height: 33px;
}

#emailAuthCode + #emailAuthBtn,
#emailAuthCode + #emailAuthBtn + #verifyAuthBtn {
    margin-left: 5px; /* 버튼 사이 간격 */
    height: 33px; /* input 높이와 맞춤 */
    padding: 0 10px; 
    font-size: 14px;
}
#emailAuthText {
...
<body>
   <div class="container">
    ...
    <div class="box">
        ...
        <div id="emailAuthText"></div> <!-- ✅ input 밑으로 이동 -->
    </div>
