...
public class Game1CommentDTO {
	...
	public Game1CommentDTO() {}
	public Game1CommentDTO(int game_comet_seq, int gameid, String game_coment_writer, String game_coment,
			String game_coment_date) {
		super();
